...
- **schedule_date = today**, or
- **schedule_date < today** → displayed with markers like “-1”, “-2”, etc.
...
- Tasks where **schedule_date > today**
...
- Its **schedule_date** automatically increments to the next day
- It appears in Today with a “-1 / -2 / …” delay marker
- **work_date never changes**
...
- It appears in Today based on its schedule_date
